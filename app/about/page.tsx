...
const qaItems = [
  ...
  {
    question: "是什么时候接触的摄影以及为什么会喜欢影像？",
    answer:
      "接触摄影是从大一开始，喜欢记录生活加入了校新媒体部门开始拍！因为我觉得很多普通的瞬间，一旦被镜头留下，就会突然变得有重量。对我来说，摄影像是在保存生活，剪辑则是在重新整理这些瞬间被看见的方式。",
  },
  {
    question: "校园生活是怎么样的？",
    answer:
      "我毕业于邵阳学院影视传播专业,在校专业排名前3%，每年都有拿校级奖学金，毕业时也被评为湖南省级、邵阳学院校级优秀毕业生。在校期间我也参加过一些比赛，像是大学生广告艺术大赛、互联网+创新创业大赛等，拿过一些奖项。通过这些经历，我积累了不少拍摄和剪辑的实战经验，也锻炼了我的创意思维和团队协作能力。",
  },
  {
